    ...
    const recipes = [
        {
            ...
            videoUrl: 'https://www.youtube.com/embed/eiYltT920EI?si=JZ6ztssH0KPcGg8i'
        },
        {
            id: 2,
            ...
            videoUrl: 'https://www.youtube.com/embed/a03U45jFxOI?si=i1KjnVbdUV33Sjxj'
        },
        {
            id: 3,
            ...
            videoUrl: 'https://www.youtube.com/embed/yGG01tj9wi4?si=vDxsk60gq0p-tkBo'
        },
        {
            id: 4,
            ...
            videoUrl: 'https://www.youtube.com/embed/1-SJGQ2HLp8?si=RVS3TC8060VnMISk'
        },
        {
            id: 5,
            ...
            videoUrl: 'https://www.youtube.com/embed/hA4yfpXeq8k?si=QbhbwdaFsdKCiy6N'
        },
        {
            id: 6,
            ...
            videoUrl: 'https://www.youtube.com/embed/JKy9TNh1xB4?si=ygi0XNKI85acJC1Q'
        }
    ];
...
function populateRelatedRecipes(relatedRecipes) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const shareButton = document.querySelector(".buttons");
    ...
    // Share links (replace with your own URL if needed)
    ...
    const shareLinks = {
      ...
      reddit: `https://www.reddit.com/submit?title=${pageTitle}&url=${pageUrl}`,
      discord: `https://discord.com/channels/@me`, // You can’t really prefill a DM here
      pinterest: `https://pinterest.com/pin/create/button/?url=${pageUrl}&description=${pageTitle}`,
      instagram: `https://www.instagram.com`, // Can't share via direct link, placeholder
      snapchat: `https://www.snapchat.com/scan`, // Placeholder for Snap
      messenger: `fb-messenger://share?link=${pageUrl}&app_id=YOUR_APP_ID`, // Works only with app
    };

    // Apply share links to buttons
    for (const [platform, link] of Object.entries(shareLinks)) {
      const btn = document.querySelector(`.${platform}-button`);
      if (btn) {
